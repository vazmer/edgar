            ...
            <tr>
                <th colspan="2">
                    <ul>
                        ...
                        <li><?php _e('In the case where Apache is not used, the .htaccess1 file located in the root directory of the WordPress installation, wp-content/w3tc/pgcache/.htaccess1 and wp-content/w3tc/min/.htaccess1 contain directives that must be manually created for your web server software.', 'w3-total-cache'); ?></li>
