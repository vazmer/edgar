...
<table cellspacing="5">
	...
	<tr>
		<td colspan="2">
			<label><input id="cdn_import_library_redirect_permanent" type="checkbox" checked="checked" /> <?php _e('Create a list of permanent (301) redirects for use in your site\'s .htaccess1 file', 'w3-total-cache'); ?></label>
		</td>
	</tr>
	<tr>
		<td colspan="2">
...
<p>
	<?php _e('Add the following directives to your .htaccess1 file or if there are several hundred they should be added directly to your configuration file:', 'w3-total-cache'); ?>
</p>
