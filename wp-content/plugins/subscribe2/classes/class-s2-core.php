...
/*		$this->profile = "<p class=\"s2_message\">" . sprintf(__('Thank you for signing up to receive your EDGARdaily e-newsletter.', 'subscribe2'), get_option('siteurl') . "/wp-admin/admin.php?page=s2") . "</p>";*/

		$this->profile = "<p class=\"s2_message\">" . sprintf(__('Thank you for signing up to receive your EDGARdaily e-newsletter.', 'subscribe2'), get_option('siteurl') . "/wp-admin/admin.php?page=s2") . "</p><p style='text-align:center;'>To subscribe with another email address <a href='".wp_logout_url( $_SERVER['REQUEST_URI'] )."' >click here</a></p>";
?>
<?php		
		if ( $this->s2_mu === true ) {
			global $blog_id;
