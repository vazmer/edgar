	...
	*/
	...
	function shortcode($atts) {
		...
		if ( strtolower($nojs) == 'true' ) {
			...
			$this->form = "<p>Want to keep up to date with all our latest news and information?</p><p>Enter your email below to be added to our mailing list.</p><form method=\"post\"" . $action . "><input type=\"hidden\" name=\"ip\" value=\"" . $_SERVER['REMOTE_ADDR'] . "\" />" . $antispam_text . "<p><input type=\"text\" name=\"email\" id=\"s2email\" value=\"" . $value . "\" size=\"" . $size . "\" />" . $wrap_text . $this->input_form_action . "</p></form>";

		} else {

			$this->form = "<p>Want to keep up to date with all our latest news and information?</p><p>Enter your email below to be added to our mailing list.</p><form method=\"post\"" . $action . "><input type=\"hidden\" name=\"ip\" value=\"" . $_SERVER['REMOTE_ADDR'] . "\" />" . $antispam_text . "<p><input type=\"text\" name=\"email\" id=\"s2email\" value=\"" . $value . "\" size=\"" . $size . "\" onfocus=\"if (this.value == '" . $value . "') {this.value = '';}\" onblur=\"if (this.value == '') {this.value = '" . $value . "';}\" />" . $wrap_text . $this->input_form_action . "</p></form>\r\n";
