					...
					<?php if(is_super_admin()): ?>
						...
						<ul>
							...
							<li>
								...
								<small><?php _e('Use this if your blog is in a sub-directory, but you want the sitemap be located in the root. Requires .htaccess1 modification.','sitemap'); ?> <a href="<?php echo $this->sg->GetRedirectLink('sitemap-help-options-adv-baseurl'); ?>"><?php _e('Learn more','sitemap'); ?></a></small>
							</li>
							<li>
								<label for="sm_b_html">
