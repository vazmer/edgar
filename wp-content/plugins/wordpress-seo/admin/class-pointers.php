	...
	class WPSEO_Pointers {
		...
		function intro_tour() {
			...
			$adminpages = array(
				...
				'wpseo_files'          => array(
					'content'       => '<h3>' . __( 'File Editor', 'wordpress-seo' ) . '</h3><p>' . __( 'Here you can edit the .htaccess1 and robots.txt files, two of the most powerful files in your WordPress install, if your WordPress installation has write-access to the files. But please, only touch these files if you know what you\'re doing!', 'wordpress-seo' ) . '</p>',
					'next'          => __( 'Next', 'wordpress-seo' ),
