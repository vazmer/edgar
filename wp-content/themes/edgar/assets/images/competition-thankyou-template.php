    ...
    <div class="content-middle">
      ...
      <div class="article-container">
        ...
        <div class="left-panel" style="min-height:100px;">
          ...
          <img src="<?php bloginfo('template_directory'); ?>/assets/images/comp-thanks-bg.png" style="margin-top:50px;" class="competition-thanks-img" /> </div>
...
<div class="left-panel">
  ...
  <div class="top-article single-content">
    ...
    <div class="post-content">
      ...
      <img src="<?php bloginfo('template_directory'); ?>/assets/images/comp-thanks-bg-mobile.png" style="margin-top:50px;" class="competition-thanks-img" />
