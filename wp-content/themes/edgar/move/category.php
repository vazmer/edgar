    ...
    <div class="content-container">
      ...
      <div class="content-middle">
        ...
        <div class="article-container">
          ...
          <div class="search search2 search3">
            <p>Part of EDGAR Middle East</p>
          ...
          <div class="left-panel">
            ...
            <div class="related-container">
              <div class="article-wrapper article-col-2 news">
                <div class="post-image"><a href="<?php the_permalink(); ?>"><img src="<?php the_field('middle_image');?>" alt="">
                  <?php if ( in_category(69) ) { ?>
                  <div class="video-tag"></div>
                  <?php } ?>
                  </a></a></div>
              ...
              <div class="article-co1-1">
                <div class="article-wrapper sports">
                  <div class="small-height"> <a href="<?php the_permalink(); ?>"><img src="<?php the_field('middle_image');?>" alt="">
                    <?php if ( in_category(69) ) { ?>
                    <div class="video-tag"></div>
                    <?php } ?>
                    </a></a> </div>
            ...
            <div class="article-wrapper misc-article">
              <div class="article-co1-1">
                <div class="article-wrapper style">
                  <div class="post-image"><a href="<?php the_permalink(); ?>"><img src="<?php the_field('thumb_image');?>" alt="">
                    <?php if ( in_category(69) ) { ?>
                    <div class="video-tag"></div>
                    <?php } ?>
                    </a></a></div>
              ...
              <div class="article-co1-1">
                <div class="article-wrapper travel">
                  <div class="post-image"><a href="<?php the_permalink(); ?>"><img src="<?php the_field('thumb_image');?>" alt="">
                    <?php if ( in_category(69) ) { ?>
                    <div class="video-tag"></div>
                    <?php } ?>
              ...
              <div class="article-co1-1">
                <div class="article-wrapper culture">
                  <div class="post-image"><a href="<?php the_permalink(); ?>"><img src="<?php the_field('thumb_image');?>" alt="">
                    <?php if ( in_category(69) ) { ?>
                    <div class="video-tag"></div>
                    <?php } ?>
            ...
            <div class="article-container bottom-article">
              <div class="article-co1-4">
                <div class="article-wrapper social">
                  <div class="post-image"><a href="<?php the_permalink(); ?>"><img src="<?php the_field('large_image');?>" alt="">
                    <?php if ( in_category(69) ) { ?>
                    <div class="video-tag"></div>
                    <?php } ?>
                    </a></a></div>
...
<div class="page-heading"><h1><?php echo($postCategoryName); ?></h1></div>
</div>
<div class="left-panel">
  <?php 
			$st = true;
			...
			while(have_posts()) : the_post();
		?>
  <div class="article-wrapper article-col-2 news <?php if ( $postcounter == 1 || $postcounter == 12 || $postcounter == 22 ) { echo("top-story-category"); } else if ( $st == true ) { echo("right-article "); }?>"  style="padding-bottom:15px;">
  ...
  <?php
		  if ( $postcounter != 1 || $postcounter != 12 ) { 
		  ...
		  if ( $postcounter == 5 || $postcounter == 9 || $postcounter == 13 || $postcounter == 17 ) {  
		   if( $before_banner_link ) { ?>
			...
			<a href="<?php echo($before_banner_link); ?>">
