          ...
          <div class="left-panel">
          	 ...
          	 <?php 	wp_reset_query();
                    ...
                    <div class="related-container">
                      <div class="article-wrapper article-col-2 news"> <div class="post-image"><a href="<?php the_permalink(); ?>"><img src="<?php the_field('middle_image');?>" alt=""><?php if ( in_category(69) ) { ?> <div class="video-tag"></div> <?php } ?></a></div>
                        <div class="article-wrapper">
                          <h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
                          <?php the_field('post_sub_header'); ?>
                        </div>
                      ...
                      <div class="article-co1-1">
                        ...
                        <div class="article-wrapper sports">
                          <div class="small-height"> <a href="<?php the_permalink(); ?>"><img src="<?php the_field('middle_image');?>" alt=""><?php if ( in_category(69) ) { ?> <div class="video-tag"></div> <?php } ?></a> </div>
              ...
              <div class="article-co1-1">
                <div class="article-wrapper style"> <div class="post-image"><a href="<?php the_permalink(); ?>"><img src="<?php the_field('thumb_image');?>" alt=""><?php if ( in_category(69) ) { ?> <div class="video-tag"></div> <?php } ?></a></div>
                  <h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
                </div>
              </div>
              ...
              <div class="article-co1-1">
                <div class="article-wrapper travel"> <div class="post-image"><a href="<?php the_permalink(); ?>"><img src="<?php the_field('thumb_image');?>" alt=""><?php if ( in_category(69) ) { ?> <div class="video-tag"></div> <?php } ?></a></div>
                  <h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
                </div>
              </div>
              ...
              <div class="article-co1-1">
                <div class="article-wrapper culture"> <div class="post-image"><a href="<?php the_permalink(); ?>"><img src="<?php the_field('thumb_image');?>" alt=""><?php if ( in_category(69) ) { ?> <div class="video-tag"></div> <?php } ?></a></div>
                  <h2><a href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
                </div>
              </div>
            </div>
            ...
            <?php $postcount++; endwhile; twentytwelve_content_nav( 'nav-below' );
			endif; ?>
  ...
  <div class="article-wrapper article-col-2 news <?php if ( $postcounter == 1 || $postcounter == 12 || $postcounter == 22 || $postcounter == 32 || $postcounter == 42) { echo("top-story-category"); } else if ( $st == true ) { echo("right-article "); }?>" style="padding-bottom:15px;">
    ...
    <div class="article-wrapper">
	  ...
	  $post_sub_hear = wp_strip_all_tags($post_sub_hear);
	   ...
	   if (strlen(  $post_sub_hear ) > 56) {echo substr(  $post_sub_hear , 0, 56). '...'; } else { echo($post_sub_hear);} 
	   ?>
    </div>
  </div>
  <?php
			...
			if ( $postcounter == 5 || $postcounter == 9 || $postcounter == 13 || $postcounter == 17 || $postcounter == 23 ) {  
		   if( $before_banner_link ) { ?>
			  ...
			  <div class="banner-insider">
              		<img src="<?php bloginfo('template_directory'); ?>/assets/images/ad-new-image.png" alt="" />
			  </div>
			  </div>
			  <?php } 		  
