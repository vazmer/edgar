...
<!-- Responsive Start -->
<meta name="HandheldFriendly" content="True"><!-- Stops zooming of Blackberry devices -->
<meta name="MobileOptimized" content="320"><!-- IE Mobile -->
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">
<meta name="viewport" content="width=device-width, minimum-scale=1.0, maximum-scale=1.0"><!-- ios and android -->
<?php	if ( is_single() ) {  	?>
...
<style>
	body{
		/* background:#000; */
		background:url(<?php bloginfo('template_directory'); ?>/assets/images/main-nav-bg.jpg);
	}
	.web-banner{
	...
	background:url(<?php echo($fb_icon); ?>) no-repeat left top;
	}
	.to-buy-container ul li.fb-icon:hover a{
		background:url(<?php echo($fb_icon); ?>) no-repeat left bottom;
	}
	.to-buy-container ul li.tt-icon a{
		background:url(<?php echo($tt_icon); ?>) no-repeat left top;
	}
	.to-buy-container ul li.tt-icon:hover a{
		background:url(<?php echo($tt_icon); ?>) no-repeat left bottom;
	}
	.to-buy-container ul li.in-icon a{
		background:url(<?php echo($in_icon); ?>) no-repeat left top;
	}
	.to-buy-container ul li.in-icon:hover a{
		background:url(<?php echo($in_icon); ?>) no-repeat left bottom;
	}
	.to-buy-container ul li.email-icon a{
		background:url(<?php echo($email_icon); ?>) no-repeat left top;
	}
	.to-buy-container ul li.email-icon:hover a{
		background:url(<?php echo($email_icon); ?>) no-repeat left bottom;
	}
	<?php endwhile; ?>
	...
	<?php  	$my_query = new WP_Query('pagename=category-info'); 
			...
			.main-nav ul li.to-know-menu a:hover{
				...
				background:url("<?php the_sub_field('category_hover_image');?>") no-repeat right 11px #000 !important;
			}
			...
			<?php }else if ( $category_name_info == 4 ) { ?>
			...
			<?php }else if ( $category_name_info == 3 ) { ?>
			...
			<?php }else if ( $category_name_info == 5 ) { ?>
			...
			<?php }else if ( $category_name_info == 6 ) { ?>
	                        ...
	                        <li class="slide right-slide">
                                <a href="javascript:void(0);" rel="bookmark">
                                	<div class="slide-title">
                                        <label><?php the_field('right_banner_title'); ?></label>
                                    </div>
	                                <img src="<?php the_field('right_banner_image'); ?>" alt="" />
                                        ...
                                        <h3 class="right-slide-title"><?php the_sub_field('right_banner_caption_txt'); ?></h3>
                            ...
                            <li class="slide left-slide">
                                <a href="javascript:void(0);" rel="bookmark">
	                                <img src="<?php the_field('left_banner_image'); ?>" alt="" />
                                        <div class="featured-text">
                                        <h3 class="left-slide-title"><?php the_field('left_banner_caption'); ?></h3>
                                        <h2></h2>
                                        <div class="featured-excerpt">
	                                        <p></p>
                                        </div><!--featured-excerpt--> 
	                        	...
	                        	<ul>
	                                ...
	                                <li class="to-know-menu sub-category"><a href="<?php echo(home_url('/category/').$parentCategorySlug[0])?>"><?php echo($parentCategoryName[0]); ?></a>
	                                	...
	                                	<div class="sub-menu-detail">
															...
															while ($my_query->have_posts()) : $my_query->the_post(); 
                                                            	if ( $term->slug == 'to-know' && $countter < 5 ) {  ?>
                                                                    <div class="menu-block">
                                                                        <a href="<?php the_permalink(); ?>"><div class="post-thumb"><img src="<?php if( get_field('thumb_image') ) { the_field('thumb_image');} else { ?><?php bloginfo('template_directory'); ?>/assets/images/default-tab.jpg<?php } ?>" alt=""></div>
                                                                        <strong><?php the_title(); ?></strong>
                                                                        <span><?php myfieldcontent(10,get_field('post_sub_header')); ?></span>
                                                                        </a>
                                                                    </div>
															<?php
                                                                    $countter++;
	                                        ...
	                                        <div class="menu-more">
	                                        	<a href="<?php echo(home_url('/category/').$parentCategorySlug[0]) ?>">more</a>
	                                        </div>   
	                                ...
	                                <li class="to-buy-menu sub-category"><a href="<?php echo(home_url('/category/').$parentCategorySlug[1]); ?>"><?php echo($parentCategoryName[1]); ?></a>
	                                	...
	                                	<div class="sub-menu-detail">
	                                        ...
	                                        <div class="menu-more">
	                                        	<a href="<?php echo(home_url('/category/').$parentCategorySlug[1]) ?>">more</a>
	                                        </div>                                        
	                                    </div>
	                                </li>                                
	                            </ul>
								...
								<ul>                               
	                                <li class="to-do-menu sub-category"><a href="<?php echo(home_url('/category/').$parentCategorySlug[2])?>"><?php echo($parentCategoryName[2]); ?></a>
	                                	...
	                                	<div class="sub-menu-detail">
	                                        ...
	                                        <div class="menu-more">
	                                        	<a href="<?php echo(home_url('/category/').$parentCategorySlug[2]) ?>">more</a>
	                                        </div>                                        
	                                    </div>
	                                </li>
	                                <li class="to-see-menu sub-category"><a href="<?php echo(home_url('/category/').$parentCategorySlug[4]) ?>"><?php echo($parentCategoryName[4]); ?></a>
	                                	...
	                                	<div class="sub-menu-detail">
	                                        ...
	                                        <div class="menu-more">
	                                        	<a href="<?php echo(home_url('/category/').$parentCategorySlug[4]) ?>">more</a>
	                                        </div>                                        
	                                    </div>
	                                </li>
	                                <li class="to-go-menu sub-category"><a href="<?php echo(home_url('/category/').$parentCategorySlug[3]) ?>"><?php echo($parentCategoryName[3]); ?></a>
	                                	...
	                                	<div class="sub-menu-detail">
	                                        ...
	                                        <div class="menu-more">
	                                        	<a href="<?php echo(home_url('/category/').$parentCategorySlug[3]) ?>">more</a>
	                                        </div>                                        
	                                    </div>
	                                </li>
	                            </ul>                     
