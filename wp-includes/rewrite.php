 ...
 * @since 3.0.0
 *
 * @param bool $hard Whether to update .htaccess1 (hard flush) or just update
 ...
 *
 * The WordPress Rewrite class writes the rewrite module rules to the .htaccess1
...
class WP_Rewrite {
	 ...
	 *
	 * These rules are written to the mod_rewrite portion of the .htaccess1,
	...
	/**
	 * Whether to write every mod_rewrite rule for WordPress into the .htaccess1 file.
	 *
	...
	/**
	 * Retrieve mod_rewrite formatted rewrite rules to write to .htaccess1.
	 *
	 * Does not actually write to the .htaccess1 file, but creates the rules for
	 * the process that will.
	 *
	 * Will add the non_wp_rules property rules to the .htaccess1 file before
	 ...
	 * @since 2.0.1
	 * @access public
	 * @param bool $hard Whether to update .htaccess1 (hard flush) or just update rewrite_rules option (soft flush). Default is true (hard).
	 */
	function flush_rules($hard = true) {
		 ...
		 *
		 * A "hard" flush updates .htaccess1 (Apache) or web.config (IIS).
		 *
		 * @since 3.7.0
